    ...
    <div className="resort-section">
      <div className="resort-post">
        ...
        <div className="resort-info">
          ...
          <p>
            Our Beautiful resort offers delicious meal in the old and modern
            world settings. The Paradise Dreamer Invites you to sample the
            ...
            savor every bite as you enjoy the finest Paradise Dreamer food and
            drink experiences.
          </p>
